...
from .serializers import PostSerializer  # Keep PostSerializer import
...
def post_list(request):
    ...
    elif request.method == 'POST':  # Create a new post
...
def hello_world(request):
    return Response({"message": "Hello from Connectly Project!"})
...
# GET, UPDATE (PUT/PATCH), DELETE A SINGLE POST
